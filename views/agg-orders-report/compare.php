        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header bg-wb-green-vibrant-header text-white font-weight-bold"> <!-- bg-dark -->
                    <i class="fas fa-chart-bar"></i> Динамика суммы заказов по месяцам
                </div>
                <div class="card-body">
    ...
    <div class="mb-5">
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['attribute' => 'amount_2026', 'label' => 'Сумма',  'hAlign' => 'right', 'format' => ['decimal', 0], 'pageSummary' => true, 'contentOptions' => ['text-align: right;'] ],
            ],
